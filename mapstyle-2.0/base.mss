...
#background {
	[zoom=12] { polygon-fill: @water; }
	[zoom=11] { polygon-fill: @water; }
	[zoom=10] { polygon-fill: @water; }
	[zoom=9]  { polygon-fill: @water; }
	[zoom=8]  { polygon-fill: @water; }
	[zoom=7]  { polygon-fill: @water; }
	[zoom<=6] { polygon-fill: @water; }
}
