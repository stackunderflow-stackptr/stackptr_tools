...
#landuse[zoom>12] {
  ...
  [type='construction']  { polygon-fill: @industrial; }
  [type='residential']   { polygon-fill: @industrial; }
  [type='common']        { polygon-fill: @park; }
  [type='forest']        { polygon-fill: @wooded; }
  [type='golf_course']   { polygon-fill: @sports; }
  [type='garden']        { polygon-fill: @sports; }
  [type='grass']         { polygon-fill: @grass; }
  [type='hospital']      { polygon-fill: @hospital; }
  [type='industrial']    { polygon-fill: @industrial; }
  [type='park']          { polygon-fill: @park; }
  [type='parking']       { polygon-fill: @parking; }
  [type='garages']       { polygon-fill: @parking; }
  ...
  [type='military']      { polygon-fill: #FCC;}
  [type='zoo'] { polygon-fill: darken(@park,30%); }
