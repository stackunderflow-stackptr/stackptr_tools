...
apt-get -y install git vim sudo postgresql-9.4-postgis-2.1 postgresql-contrib-9.4 build-essential screen libxml2-dev libz-dev libbz2-dev libgeos-dev libgeos++-dev libproj-dev postgresql-server-dev-9.4 libboost-dev autoconf libtool libexpat-dev libboost-system-dev libboost-filesystem-dev libboost-thread-dev lua5.2 liblua5.2-dev axel htop mosh ethtool
adduser gm sudo
